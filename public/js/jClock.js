...
function jClock(config){
	...
	function paint(secRad,minRad,hourRad){
		...
		aPointer(getVec(minRad,120/300 * width),'rgba(67,67,67, 0.8)',3);
		// aPointer(getVec(hourRad,60),null,4);
		aPointer(getVec(hourRad,60/300 * width),'rgba(67,67,67, 0.8)',4);
